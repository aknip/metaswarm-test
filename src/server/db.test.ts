...
describe('createDatabase (SUC-8)', () => {
  it('DB-1: creates in-memory database with todos table', () => {
...
describe('TodoRepo', () => {
  ...
  describe('list (SUC-2)', () => {
    it('DB-3a: returns empty array when no todos exist', () => {
      expect(repo.list()).toEqual([])
    })

    it('DB-3b: returns all todos in reverse chronological order', () => {
      repo.create('First')
      repo.create('Second')
  ...
  describe('get (SUC-3)', () => {
    ...
    it('DB-4b: returns undefined for non-existent id', () => {
      expect(repo.get('nonexistent')).toBeUndefined()
    })
  })

  describe('create (SUC-1)', () => {
    it('DB-2: creates a todo with default values', () => {
  ...
  describe('update (SUC-4)', () => {
    it('DB-5a: updates title and completed status', () => {
    ...
    it('DB-5b: returns undefined for non-existent id', () => {
      expect(repo.update('nonexistent', 'Title', false)).toBeUndefined()
    })
  })

  describe('delete (SUC-5)', () => {
    it('DB-6a: deletes a todo and returns it', () => {
    ...
    it('DB-6b: returns undefined for non-existent id', () => {
